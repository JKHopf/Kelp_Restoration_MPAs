...
% Variable variables -------------------------------------    
    ...
    % Exploration parameters: 
        ...
        mf_vec = nan; % linspace(SpParas.mf/2,SpParas.mf*2,10); % 
...
% DD Function:
DD_func =  str2func('Func_ProjPop_KR4pop_BH'); 
...
% population abundance at equilibrium
t_eq = 100;
...
% xlabel('Fishing pressure (mf) (area protect = 0.2, area restored = 0.2)')
...
% xlabel('Strength of fish-kelp itneraction (gamma_g)')
hold on
